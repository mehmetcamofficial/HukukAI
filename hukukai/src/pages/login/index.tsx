    ...
    <main className="min-h-[100dvh] bg-[#f6f6f2] p-4 text-[#132b41] sm:p-6 lg:p-8">
      <div className="mx-auto grid min-h-[calc(100dvh-2rem)] max-w-[1440px] overflow-hidden border border-[#cdd7da] bg-white shadow-[0_20px_60px_rgba(20,45,66,.12)] sm:min-h-[calc(100dvh-3rem)] lg:grid-cols-[1.08fr_.92fr]">
        <section className="relative hidden overflow-hidden bg-[#17334b] p-10 text-white lg:flex lg:flex-col xl:p-14">
          ...
          <div className="relative z-10 flex items-center justify-between gap-4"><Link href="/" className="flex w-fit items-center gap-2 text-[17px] font-semibold tracking-tight"><span className="grid h-8 w-8 place-items-center bg-[#6e98b8]"><Scale size={17} /></span>Hukuk<span className="text-[#95b7cd]">AI</span></Link><Link href="/" className="inline-flex min-h-11 items-center gap-2 text-[11px] font-semibold text-[#c5d9e4] hover:text-white"><ArrowLeft size={14} /> Ana Sayfaya Dön</Link></div>
        ...
        <section className="flex items-center justify-center p-5 sm:p-10 lg:p-14">
          <div className="w-full max-w-[390px]">
            <div className="mb-10 flex items-center justify-between gap-3 lg:hidden"><Link href="/" className="flex w-fit items-center gap-2 text-[17px] font-semibold tracking-tight"><span className="grid h-8 w-8 place-items-center bg-[#17334b] text-white"><Scale size={17} /></span>Hukuk<span className="text-[#6085a1]">AI</span></Link><Link href="/" className="inline-flex min-h-11 items-center gap-1.5 text-[11px] font-semibold text-[#52728a]"><ArrowLeft size={14} /> Ana Sayfaya Dön</Link></div>
